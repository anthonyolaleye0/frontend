...
import type {
  ReusableScheduleDisplayTableProps,
  ScheduleTaxLawTableObjType,
...
const ReusableScheduleDisplayTable: React.FC<
  ReusableScheduleDisplayTableProps
> = ({
  data,
  loading,
  ...
  const columns: TableColumn<ScheduleTaxLawTableObjType>[] = [
    {
      name: (
        ...
        return (
          <div className="relative inline-block text-left">
            <div className="flex items-center gap-2 justify-center">
              ...
              >
                <Link
                  to={`/dashboard/${userRole}/tax-laws/${row?.taxLaw}/schedules/${rowId}`}
...
export default ReusableScheduleDisplayTable;
