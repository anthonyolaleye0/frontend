...
import type { AmendSubSectionFormProps } from '../../../constants/types';
...
const AmendSubSectionForm: React.FC<AmendSubSectionFormProps> = ({
  setIsModalOpen,
  subsection,
}) => {
  const { amendSubSection } = useAmendmentApis();
  ...
  const onSubmit = async (data: FormValues) => {
    ...
    try {
      ...
      const response = await amendSubSectionMutation(payload);
...
export default AmendSubSectionForm;
